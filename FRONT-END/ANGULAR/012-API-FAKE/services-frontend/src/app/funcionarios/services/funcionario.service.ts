...
export class FuncionarioService {
  private readonly baseUrl: string = 'http://localhost:8080/services/employees';
  atualizarFuncionariosSub$: BehaviorSubject<boolean> = new BehaviorSubject(
    true
  );
      ...
      return this.storage
        ...
        .pipe(
          mergeMap(() => {
            ...
            return this.http.delete<any>(`${this.baseUrl}/${func.idEmployee}`);
          })
        );
    }
  ...
  atualizarFuncionario(func: Funcionario, foto?: File): any {
    ...
    if (foto == undefined) {
      return this.http
        .put<Funcionario>(`${this.baseUrl}/${func.idEmployee}`, func)
        .pipe(
          tap((funcionario) => {
